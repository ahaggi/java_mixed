...
public class Institutt {
	private final int STDK = 10; //Totalt : 10 kurs
	private final int STDS = 300;// max 300 student
	private int antKurs; //max 4 kurs per student
	private Kurs[] kurs;
	...
	public void registrerStudent() {
		...
		while (!kurskode.equals("")) {
			...
			if (stud.maksKurs()) {
				skjerm.outln("Kan ikke fålge flere kurs. ");
			} else if (k == null) {
