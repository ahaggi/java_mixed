...
public class Format {
    ...
    /**
     * H�yrejusterer teksten <code>s</code> p�
     * <code>width</code> plasser. Hvis oppgitt antal plasser er mindre
     * en lengden p� teksten markeres det med intill tre prikker.
     * @param s teksten som skal justeres
     * @param width antal plasser teksten skal justeres p�.
     * @return Den nye h�yrejusterte teksten. Blanke tegn til slutt i
     ...
     * @param c tegnet som skal h�yrejusteres
     ...
     * sentreres p� oppgitt antall plasser.
     * @see Format#align(String, int)
     */
    public static String center(String s, int width) {
        // F�rst - hvis teksten er for lang, fjern annenhver f�rste og
        // siste bokstav:
        boolean last = true;
        ...
        // width. Fyll p� med blanke f�rst og sist i teksten.
        last = false;
        while (s.length() < width) {
            if (last) {
                s = s + " ";
