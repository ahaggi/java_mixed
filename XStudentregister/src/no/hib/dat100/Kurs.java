...
public class Kurs {
	private final int STD = 300; //legg merke til vi har  lag max antall studenter i "kurs klasse"
	private String kurskode;
	private Ukedag dag;
	private int tid;
	private Student[] studenter; //her kan vi søke etter hvor mange studenter i hvert enkelt kurs
