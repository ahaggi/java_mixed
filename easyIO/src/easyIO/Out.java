...
public class Out extends OutExp {
    ...
    /**
     * Konstrukt�r for oppretting av skriveobjekt til skjerm (System.out)
     */
    public Out() {
        super();
    }
    ...
    /**
     * Konstrukt�r for opprtetting av skriveobjekt til fil med append.
     */
    ...
    /* Metodene under kaller alle p� superklassens tilsvarende metode.
     * Dette er kun gjort for � f� generert full dokumentasjon ogs�
     * for denne klassen.
     */
