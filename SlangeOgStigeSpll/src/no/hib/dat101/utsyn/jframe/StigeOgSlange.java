...
public class StigeOgSlange extends JFrame implements ChangeListener {
	...
	public StigeOgSlange() {
		...
		// begynner fra bunn-venstre og itillegg hvert lbl_ruter[x][y] f�r samme
		// form som spillet
		...
		// sjekker at det st�r et spill i DB
		lagSpill();
	 ...
	 * fra bunn-venstre og itillegg hvert lbl_ruter[x][y] f�r samme form som
	 * spillet
	 */
	...
	/**
	 * det er behov for at det fins et spill p� DB slik at vi kan bruke fredig
	 * laget bertt og brikker
	 */
...
//		}
	...
	/** setter brikkkere p� start posisjon etter at spill er ferdig */
	 ...
	 * 
	 * @param logg
	 *            logg f�r info om hvert tur/handling fra Logg klasse
	 */
	...
	Action enter = new AbstractAction() {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				...
				//laster ned brett og brikker
				spill = db.getSpill();
				Brett brett = spill.getBrett();
				List<Brikke> brikke = spill.getBrikker();

				spill = new Spill(brett, brikke, antallspillere);
				db.setSpill(spill);
//				db.persist();
